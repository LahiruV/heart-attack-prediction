        ...
        <footer className="bg-white mt-8 border-t border-gray-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-600 text-sm">
                            Yenuka Health is your trusted AI-based platform for heart health monitoring and risk prediction. We empower individuals with insights to make proactive lifestyle choices.
                        </p>
                    </div>
                ...
                <div className="mt-12 border-t border-gray-200 pt-6 text-center text-gray-600 text-sm space-y-1">
                    <p>© {currentYear} Yenuka Health. All rights reserved.</p>
